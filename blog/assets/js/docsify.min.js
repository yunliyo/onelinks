! function () {
        ...
        D = function (n) {
            ...
            return n && (e.__proto__ = n), ((e.prototype = Object.create(n && n.prototype)).constructor = e).prototype.getCurrentPath = function () {
                ...
                void 0 === i && (i = d), p("click", function (e) {
                    ...
                    n && "A" === n.tagName && !/_blank/.test(n.target) && (e.preventDefault(), n = n.href, -1 !== o.config.crossOriginLinks.indexOf(n) ? window.open(n, "_self") : window.history.pushState({
                        key: n
                    }, "", n), i({
                        event: e,
                        source: "navigate"
    ...
    function jn(e, t) {
        return e.replace(/<(code|pre|script|template)[^>]*?>[\s\S]+?<\/(code|pre|script|template)>/g, function (e) {
            ...
            return i = e, o = n, e = t, n = Rn.data[o], i, i = n ? e && /unicode/.test(n) ? '<span class="emoji">' + n.replace("unicode/", "").replace(/\.png.*/, "").split("-").map(function (e) {
                return "&#x" + e + ";"
    ...
    var qn, Pn = be(function (e) {
        var u, f, p, d, n, g = function (u) {
                ...
                T = {
                        ...
                        clone: function i(e, o) {
                            ...
                            switch (o = o || {}, T.util.type(e)) {
                                case "Object":
                                    ...
                                    return t;
                                case "Array":
                                    return (n = T.util.objId(e), o[n]) ? o[n] : (t = [], o[n] = t, e.forEach(function (e, n) {
                                        t[n] = i(e, o)
                                    }), t);
                                default:
                                    return e
                    ...
                    languages: {
                        ...
                        insertBefore: function (i, e, n, o) {
                            ...
                            return o[i] = r, T.languages.DFS(T.languages, function (e, n) {
                                n === u && e != i && (this[e] = r)
                            }), r
                        },
                        DFS: function e(n, i, o, t) {
                            ...
                            for (a in n) n.hasOwnProperty(a) && (i.call(n, a, n[a], o || a), r = n[a], "Object" !== (c = T.util.type(r)) || t[u(r)] ? "Array" !== c || t[u(r)] || (t[u(r)] = !0, e(r, i, a, t)) : (t[u(r)] = !0, e(r, i, null, t)))
                        }
                    },
                    plugins: {},
                    ...
                    highlightElement: function (e, n, i) {
                        ...
                        function c(e) {
                            r.highlightedCode = e, T.hooks.run("before-insert", r), r.element.innerHTML = r.highlightedCode, T.hooks.run("after-highlight", r), T.hooks.run("complete", r), i && i.call(r.element)
                        }
                        if (T.hooks.run("before-sanity-check", r), (a = r.element.parentElement) && "pre" === a.nodeName.toLowerCase() && !a.hasAttribute("tabindex") && a.setAttribute("tabindex", "0"), !r.code) return T.hooks.run("complete", r), void(i && i.call(r.element));
                        T.hooks.run("before-highlight", r), r.grammar ? n && u.Worker ? ((n = new Worker(T.filename)).onmessage = function (e) {
                            c(e.data)
            ...
            if (u.Prism = T, C.stringify = function n(e, i) {
                ...
                }, !u.document) return u.addEventListener && (T.disableWorkerMessageHandler || u.addEventListener("message", function (e) {
            ...
            return o && (T.filename = o.src, o.hasAttribute("data-manual") && (T.manual = !0)), T.manual || ("loading" === (e = document.readyState) || "interactive" === e && o && o.defer ? document.addEventListener("DOMContentLoaded", t) : window.requestAnimationFrame ? window.requestAnimationFrame(t) : window.setTimeout(t, 16)), T
    ...
    In.prototype.compileEmbed = function (e, n) {
        ...
        return t.heading = e.heading = function (e, n) {
            ...
            /<!-- {docsify-ignore} -->/g.test(o) && (o = o.replace("\x3c!-- {docsify-ignore} --\x3e", ""), e.title = Ln(o), e.ignoreSubHeading = !0), /{docsify-ignore}/g.test(o) && (o = o.replace("{docsify-ignore}", ""), e.title = Ln(o), e.ignoreSubHeading = !0), /<!-- {docsify-ignore-all} -->/g.test(o) && (o = o.replace("\x3c!-- {docsify-ignore-all} --\x3e", ""), e.title = Ln(o), e.ignoreAllSubs = !0), /{docsify-ignore-all}/g.test(o) && (o = o.replace("{docsify-ignore-all}", ""), e.title = Ln(o), e.ignoreAllSubs = !0);
            i = Cn(t.id || o), t = a.toURL(a.getCurrentPath(), {
                id: i
            });
            ...
            var o = e,
                ...
                r = a.str,
                a = a.config;
            return n = r, a["no-zoom"] && t.push("data-no-zoom"), n && t.push('title="' + n + '"'), a.size && (n = (r = a.size.split("x"))[0], (r = r[1]) ? t.push('width="' + n + '" height="' + r + '"') : t.push('width="' + n + '"')), a.class && t.push('class="' + a.class + '"'), a.id && t.push('id="' + a.id + '"'), T(e) || (o = q(p, R(d.getCurrentPath()), e)), 0 < t.length ? '<img src="' + o + '" data-origin="' + e + '" alt="' + i + '" ' + t.join(" ") + " />" : '<img src="' + o + '" data-origin="' + e + '" alt="' + i + '"' + t + ">"
        }), t.list = {
            renderer: e
    ...
    function Wn(n, i, o, t, a, e) {
        n = e ? n : n.replace(/\/$/, ""), (n = R(n)) && X(a.router.getFile(n + o) + i, !1, a.config.requestHeaders).then(t, function (e) {
            return Wn(n, i, o, t, a)
        })
    }
    ...
    var Qn, Jn = function (e) {
        ...
        return e && (n.__proto__ = e), ((n.prototype = Object.create(e && e.prototype)).constructor = n).prototype._renderTo = function (e, n, i) {
            ...
            ! function (e) {
                ...
                s || (i = C(e.getCurrentPath()), x("scroll", function () {
                    return le(i)
                }), p("scroll", function () {
                    return le(i)

...
! function () {
    ...
    function n(e) {
        ...
        function u(e, t, n, r) {
            ...
            d(e = void 0 !== o && !1 === Boolean(o) ? "" : o || e, n, r, (function (e, r) {
                null === c[t] && (r.forEach((function (e) {
                    return a.onError(e.xhr, n, e.url)
                })), !a.filter || a.filter.test(e) ? c[t] = e : c[t] = "", i())
            }))
        }
        ...
        function l(e, t) {
            var a = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [],
                s = {};
            return s.rules = (e.replace(n, "").match(o) || []).filter((function (e) {
            ...
            i.rules.length ? t(i.absoluteUrls, {
                ...
                onError: function (t, a, u) {
                    s.push({
                        xhr: t,
                        url: a
                    }), c.push(i.rules[u]), d(e, n, r, o, s, c)
                },
        ...
        s.length ? s.forEach((function (e, n) {
            ...
            if (l && !d) t(o, {
                ...
                var m = e.textContent;
                a.useCSSOM && (m = Array.apply(null, e.sheet.cssRules).map((function (e) {
                    return e.cssText
                })).join("")), u(m, n, e, location.href)
            } else c[n] = "", i()
        })) : a.onComplete("", [])
    }
    ...
    function c(e, t, n) {
        ...
        if (i >= 0 && u > 0) {
            if (e === t) return [i, u];
            for (r = [], a = n.length; l >= 0 && !c;) l == i ? (r.push(l), i = n.indexOf(e, l + 1)) : 1 == r.length ? c = [r.pop(), u] : ((o = r.pop()) < a && (a = o, s = u), u = n.indexOf(t, l + 1)), l = i < u && i >= 0 ? i : u;
            r.length && (c = [a, s])
        }
        return c
    }
    ...
    function i(t) {
        ...
        function p() {
            ...
            if (e) {
                ...
                /\/\*/.test(r) && (r = r.replace(/\/\*([^*]|[\r\n]|(\*+([^*/]|[\r\n])))*\*\/+/g, ""));
                var o = /["']\w*,\w*["']/.test(r);
                return o && (r = r.replace(/"(?:\\"|[^"])*"|'(?:\\'|[^'])*'/g, (function (e) {
                    return e.replace(/,/g, "‌")
                }))), n = /,/.test(r) ? r.split(/\s*(?![^(]*\)),\s*/) : [r], o && (n = n.map((function (e) {
                    return e.replace(/\u200C/g, ",")
                }))), n
            }
        }
        ...
        function O() {
            if (d(), "@" === t[0]) {
                ...
                if (e && !a.preserveStatic) {
                    var n = !1;
                    if (e.declarations) n = e.declarations.some((function (e) {
                        return /var\(/.test(e.value)
                    }));
                    else n = (e.keyframes || e.rules || []).some((function (e) {
        ...
        function _() {
            ...
            var s = p() || [],
                i = a.preserveStatic ? h() : h().filter((function (e) {
            ...
            return s.length || c("selector missing"), {
                type: "rule",
                selectors: s,
                declarations: i
            }
    ...
    function d(e, t) {
        e.rules.forEach((function (n) {
            n.rules ? d(n, t) : n.keyframes ? n.keyframes.forEach((function (e) {
    ...
    function f(t) {
        var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
            ...
            o = e({}, r, n);
        return "string" == typeof t && (t = i(t, o)), d(t.stylesheet, (function (e, t) {
            for (var n = 0; n < e.length; n++) {
                ...
                if ("declaration" === a)
                    if (o.preserveVars || !s || 0 !== s.indexOf("--")) {
                        if (-1 !== c.indexOf("var(")) {
                            var i = p(c, o);
                            i !== r.value && (i = m(i), o.preserveVars ? (e.splice(n, 0, {
                                type: a,
                                property: s,
                                value: i
                            }), n++) : r.value = i)
    ...
    function L() {
        ...
        if (v) {
            ...
            if (!1 === o.watch && S && (S.disconnect(), S = null), !o.__benchmark) {
                ...
                if (o.__benchmark = N(), o.exclude = [S ? '[data-cssvars]:not([data-cssvars=""])' : '[data-cssvars="out"]', "link[disabled]:not([data-cssvars])", o.exclude].filter((function (e) {
                        return e
                    })).join(","), o.variables = j(o.variables), d.forEach((function (e) {
                ...
                if (h && o.onlyLegacy) {
                    ...
                    onComplete: function (t, n) {
                        var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : [],
                            d = e({}, w.dom, w.user);
                        if (w.job = {}, r.forEach((function (e, t) {
                                var r = n[t];
                                if (e.__cssVars = e.__cssVars || {}, e.__cssVars.text = r, b.cssVars.test(r)) try {
                                    var c = i(r, {
                            ...
                            })), e(w.job, w.dom), o.updateDOM ? (e(w.user, o.variables), e(w.job, w.user)) : (e(w.job, w.user, o.variables), e(d, o.variables)), y.job > 0 && Boolean(Object.keys(w.job).length > Object.keys(d).length || Boolean(Object.keys(d).length && Object.keys(w.job).some((function (e) {
                                return w.job[e] !== d[e]
                            }))))) V(o.rootElement), L(o);
                        else {
                            var m = [],
                                    ...
                                    if (t.__cssVars.tree) try {
                                        ...
                                        if (o.updateDOM) {
                                            ...
                                            if (t.getAttribute("data-cssvars") || t.setAttribute("data-cssvars", "src"), i.length && d) {
                                                ...
                                                })), E.textContent = i, m.push(i), p.push(E), E.parentNode || t.parentNode.insertBefore(E, t.nextSibling))
                                            }
            ...
            else document.addEventListener("DOMContentLoaded", (function e(n) {
    ...
    function k(e) {
        ...
        window.MutationObserver && (S && (S.disconnect(), S = null), (S = new MutationObserver((function (o) {
            o.some((function (o) {
                return function (r) {
                    var o = !1;
    ...
    function M(e, t) {
        return (e.replace(b.cssComments, "").match(b.cssUrls) || []).forEach((function (n) {
    ...
    if (window) {
        ...
        L(B), document.documentElement.classList.add("themeable"), document.body.setAttribute("data-platform", navigator.platform), window.$docsify = window.$docsify || {}, window.$docsify.plugins = [].concat([function (e, t) {
            e.init((function () {
            ...
            e.doneEach((function () {
                ...
                e.forEach((function (e) {
                    var t = "focus-within";
                    q(e, "span", 0), e.addEventListener("focusin", (function (n) {
            ...
            e.ready((function () {
                ...
                e && e.addEventListener("click", (function (r) {
                    (r.target === n || n.contains(r.target)) && (e.classList.remove("show"), t.focus())
                })), t && t.addEventListener("input", (function (n) {
            ...
            return null !== e
        })), window.$docsify.search = window.$docsify.search || {}, window.$docsify.search.hideOtherSidebarContent = !0, window.$docsify.themeable = window.$docsify.themeable || {}, window.$docsify.themeable.version = R, window.$docsify.themeable.semver = R.split("."), window.$docsify.themeable.util = {
            cssVars: function () {

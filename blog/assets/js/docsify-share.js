! function (e) {
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.install = void 0, t.install = function (e, t) {
        var n, o, i, l, c, u, f, h, d, p, b = null != t.config.share.facebook ? s("https://www.facebook.com/sharer.php?u=" + (null !== (n = t.config.share.facebook.url) && void 0 !== n ? n : window.location.href), "fab indigo", "Facebook", "fa fa-facebook animated") : "",
            ...
            k = '<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">',
            _ = [k, '<link rel="stylesheet" href="https://unpkg.com/docsify-share/assets/css/docsify-share.min.css">', '<div class="fabs">', g, y, b, m, w, v, '<a target="_blank" class="fab light-green big-fab" tooltip="Share"><i class="fa fa-share-alt"></i></a>', "</div>"].join("");
        if (null != t.config.share.options) {
            if (null != t.config.share.options.theme)
                if ("open-window" == t.config.share.options.theme) _ = [k, '<link rel="stylesheet" href="https://unpkg.com/docsify-share/assets/css/docsify-share-open-window.min.css">', '<div class="share-button">', '<div class="share-button__back">', g, y, b, m, w, v, "</div>", '<div class="share-button__front">', '<p class="share-button__text"><span class="fa fa-share-alt"></span></p>', "</div>", "</div>"].join("");
                else if ("slide-bar" == t.config.share.options.theme) _ = [k, '<link rel="stylesheet" href="https://unpkg.com/docsify-share/assets/css/docsify-share-slide-bar.min.css">', '<button class="btn-share">', g, y, b, m, w, v, '<span class="btn-fab"><span class="fa fa-share-alt"></span></span>', "</button>"].join("");
            else if ("flip-it" == t.config.share.options.theme) _ = [k, '<link rel="stylesheet" href="https://unpkg.com/docsify-share/assets/css/docsify-share-flip-it.min.css">', '<div class="fab-container">', '<div class="btn-fab"><span class="fa fa-share-alt"></span></div>', '<div class="back">', g, y, b, m, w, v, "</div>", "</div>"].join("");
